...
class ViR(nn.Module):
    def __init__(self, *, image_size, patch_size, bucket_size, num_classes, dim, depth, heads, num_mem_kv, n_hashes=2, pool = 'cls', channels = 3, dim_head = 64, emb_dropout = 0.):
        super().__init__()
        ...
        self.transformer = Reformer(dim, depth, heads, dim_head, bucket_size=bucket_size, n_hashes=n_hashes, num_mem_kv=num_mem_kv)
...
class ViRWithArcMargin(nn.Module):
    def __init__(self, *, image_size, patch_size, bucket_size, num_classes, dim, depth, heads, num_mem_kv, n_hashes=2, pool='cls', channels=3, dim_head=64, emb_dropout=0., arc_s=30.0, arc_m=0.50):
        ...
        # Replace MLP head with ArcMargin
        self.arc_margin = ArcMarginProduct(dim, num_classes, s=arc_s, m=arc_m)
